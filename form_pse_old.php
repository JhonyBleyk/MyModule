	...
	else
	{
		...
		try 
		{
			...
			else
			{
				...
				{
					$smarty->assign("ERROR_RESPUESTA", "<br><h1> ERROR DE COMUNICACIÓN CON EL MEDIO DE PAGO HAGA CLICK <a href='index.php?controller=order&step=1'>AQUI</a> PARA SELECCIONAR OTRO MEDIO DE PAGO <br>");
				...
				elseif ($array_datos['code'] == "SUCCESS") 
				{
					...
					{
						$smarty->assign("ERROR_RESPUESTA", "<br><h1> ERROR DE COMUNICACIÓN CON EL MEDIO DE PAGO HAGA CLICK <a href='index.php?controller=order&step=1'>AQUI</a> PARA SELECCIONE OTRO MEDIO DE PAGO 2 <br>");
	...
	try 
	{
		...
		else
		{
			...
			else
			{
				...
				if ($dato1 == "ERROR") 
				{
					$smarty->assign("ERROR_RESPUESTA", "<br><h1> ERROR DE COMUNICACIÓN CON EL MEDIO DE PAGO HAGA CLICK <a href='index.php?controller=order&step=1'>AQUI</a> Y SELECCIONE OTRO MEDIO DE PAGO <br>");
